...
int main() {
    ...
    int velocidad_viento, humedad;
    char animo_elfos, animo_enanos;
    ...
    velocidad_viento = velocidad_del_viento_segun_dia(dia);
    humedad = humedad_segun_hora(hora);
    animo_elfos = estado_de_animo(legolas_pie, legolas_cena, legolas_horas_dormidas);
    animo_enanos = estado_de_animo(gimli_pie, gimli_cena, gimli_horas_dormidas);
    
    mostrar_analisis(velocidad_viento, humedad, animo_elfos, animo_enanos);
